...
public class UsuarioController {
	...
	@Operation(summary = "Eliminar usuario", description = "Ingresar userId. Devuelve true si se pudo eliminar el usuario y false en otro caso.Elimina el usuario y las billeteras asociadas.")
	...
	private Usuario getUsuarioById(
