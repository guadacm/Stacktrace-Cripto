...
import com.example.demo.services.BilleteraService;
...
public class BilleteraController {
	...
	public boolean deleteBilletera(
			@Parameter(description = "Id que desea eliminar. Use 1 al 10 para probar. ", required = true, example = "5") @PathVariable("billeteraId") Long billeteraId) {
	...
	public List<Billetera> getBilleterasHuerfanas() {
		return billeteraService.getBilleteraHuerfanas();
	}
	...
	private Billetera getBilleteraById(
			@Parameter(description = "billeteraId que desea buscar. Use 1 al 10 para probar. ", required = true, example = "5") @PathVariable("billeteraId") Long billeteraId) {
	...
	public Billetera registrarBilletera(@RequestBody Long userId) {
		Billetera billetera = billeteraService.registrarBilletera(userId);
		System.out.println(">> BilleteraController");
		return billetera;
	}
